# This is a rather inelegent way of installing software compared to the winget package manager that Microsoft has developed for non-enterprise versions of Windows
# PowerShell remoting requires that the cmdlet being invoked be installed on the remote server, preventing us from using winget here
# The progress of winget implementation on Windows Server can be tracked at the following link:
